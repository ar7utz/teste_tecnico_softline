    ...
    public class ApiDBcontext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cliente>().HasData(
                new Cliente { Id = 1, Codigo = 1, Nome = "João Carlos", Fantasia = "João Informática", Documento = "123.456.789-00", Endereco = "Rua das Flores, 100" },
                new Cliente { Id = 2, Codigo = 2, Nome = "Maria Souza", Fantasia = "Maria Tech", Documento = "987.654.321-00", Endereco = "Av. Principal, 200" }
            );
        }
    }
}